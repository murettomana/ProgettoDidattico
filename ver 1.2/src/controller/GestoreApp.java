...
public class GestoreApp {
    ...
    public void aggiungiCorso(String codice, String nome, int durata) {
        CorsoUni c = new CorsoUni( codice,  nome,  durata);
        elencoCorsi.add(c);
...
//Gestione Appelli
    public void aggiungiAppello(String idAppello, String data, String codiceDisciplina) {
        AppelloEsame a = new AppelloEsame( idAppello,  data,  codiceDisciplina);
        elencoAppelli.add(a);
    }
    ...
    //Gestione Docenti
    public void aggiungiDocente(String matricola, String nome, String cognome, String codiceDisciplina) {
        Docente d = new Docente( matricola,  nome,  cognome, codiceDisciplina );
        elencoDocenti.add(d);
    }
    ...
    //Gestione Iscrizioni
    public void aggiungiIscrizione(String idAppello, String matricolaStudente) {
        Iscrizione i = new Iscrizione(idAppello, matricolaStudente);
        elencoIscrizioni.add(i);
    }
    ...
    //Gestione Discipline
    public void aggiungiDisciplina(String codice, String nome, int CFU, String codiceCorso, ArrayList<Docente> docenti, ArrayList<AppelloEsame> appelli, ArrayList<Studente> studenti) {
        Disciplina d = new Disciplina(codice, nome, CFU, codiceCorso, elencoDocenti, elencoAppelli, elencoStudenti);
